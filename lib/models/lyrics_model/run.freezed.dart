...
abstract class $RunCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? text, bool? bold, bool? italics, bool? strikethrough});
}
...
class _$RunImpl implements _Run {
  _$RunImpl({this.text, this.bold, this.italics, this.strikethrough});
  ...
  @override
  String toString() {
    return 'Run(text: $text, bold: $bold, italics: $italics, strikethrough: $strikethrough)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, text, bold, italics, strikethrough);
...
abstract class _Run implements Run {
  factory _Run(
      ...
      final bool? bold,
      final bool? italics,
      final bool? strikethrough}) = _$RunImpl;
